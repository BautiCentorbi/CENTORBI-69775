export const products = [
    {   
        ...
        lgDescription: 'Lorem Lorem Impsum dolor sit amet consceptuars it all jaesn masjes niptum sala ma lecum Lorem Impsum dolor sit amet consceptuars it all jaesn masjes niptum sala ma lecum Lorem Impsum dolor sit amet consceptuars it all jaesn masjes niptum sala ma lecum',
        price: 75000,
        stock: 0,
...
export const getProductsById = (id) => {
    return new Promise ((res) => {
        console.log(id)
        const filteredById = products.find((producto) => producto.id === parseInt(id))
...
export const priceConverter = (price) => {
    const convertedPrice = price.toLocaleString('es',{
        useGrouping: true,
        currency: 'ARS',
        style: 'currency',
    })
