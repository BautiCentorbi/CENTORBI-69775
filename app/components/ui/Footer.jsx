    ...
    <footer className='my-8'>
        <div className="grid grid-cols-1 md:grid-cols-3 md:mx-36 justify-center gap-10">
            <div className="flex flex-col items-center justify-center align-center">
              <MainLogo className='transition text-white hover:text-ourpink-light hover:scale-110 w-56 h-56 md:w-80  md:h-80'/>
            </div>
            ...
            <div className="flex flex-row gap-4 items-center justify-center">
              <Link target='blank' rel='noreferrer, noopener, nofollow' href='https://instagram.com/centorbii'>
                <InstagramLogo className='transition size-16 md:size-20 text-white hover:text-ourpink-light hover:scale-125' />
              </Link>
              <Link target='blank' rel='noreferrer, noopener, nofollow' href='https://github.com/BautiCentorbi'>
                <GithubLogo className='transition size-16 md:size-20 text-white hover:text-ourpink-light hover:scale-125' />
              </Link>
              <Link target='blank' rel='noreferrer, noopener, nofollow' href='https://x.com/centorbiiy'>
                <TwitterLogo className= 'transition size-16 md:size-20 text-white hover:text-ourpink-light hover:scale-125' />
              </Link>
            </div>
        </div>
